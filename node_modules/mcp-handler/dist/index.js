  ...
  return function mcpApiHandler(req, res) {
    return chunkUILOG6SR_js.__async(this, null, function* () {
      ...
      if (url.pathname === streamableHttpEndpoint) {
        ...
        let logs = [];
        const cleanup = (reason) => chunkUILOG6SR_js.__async(this, null, function* () {
          if (isCleanedUp)
            return;
          isCleanedUp = true;
        ...
        try {
          ...
          handleMessage = (message) => chunkUILOG6SR_js.__async(this, null, function* () {
        ...
        let isCleanedUp = false;
        const cleanup = () => chunkUILOG6SR_js.__async(this, null, function* () {
          if (isCleanedUp)
            return;
          isCleanedUp = true;
          if (timeout) {
        ...
        const sendResponse = (status, body2) => chunkUILOG6SR_js.__async(this, null, function* () {
          if (!hasResponded) {
            hasResponded = true;
        ...
        const handleResponse = (message) => chunkUILOG6SR_js.__async(this, null, function* () {
          try {
        ...
        try {
          ...
          res.on("error", (error) => chunkUILOG6SR_js.__async(this, null, function* () {
